            ...
            <div class="row">
                <div class="col-xs-6 col-sm-8 col-md-9">
                    <div class="header-top_address">
                        ...
                        <div class="header-top_list">
                            <span class="icon-envelope-open"></span>info@LailSchool.com
                        </div>
                        <div class="header-top_list">
                ...
                <div class="col-md-12">
                    <div class="single-item">
                        <div class="quote">
                            ...
                            <p class="quote_text">LailSchool benar-benar mengagumkan. Saya sangat senang bisa bergabung dengan LailSchool dan menjadi siswa terbaik tahun 2018.</p>
                        ...
                        <div class="quote">
                            <i class="fa fa-quote-left" aria-hidden="true"></i>
                            <p class="quote_text">LailSchool benar-benar mengagumkan. Saya sangat senang bisa bergabung dengan LailSchool dan menjadi siswa terbaik tahun 2017. </p>
                            <div class="testi-img_block">
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="foot-logo">
                            ...
                            <p><?php echo date('Y');?> © copyright by LailSchool. <br>All rights reserved.</p>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="sitemap">
